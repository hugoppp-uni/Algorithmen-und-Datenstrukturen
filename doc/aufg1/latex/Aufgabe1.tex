...
\begin{document}
    ...
    Gibt true zurück, wenn der Baum InitBT entspricht, sonst false.
    ...
    anschließen elementweise auf Gleichheit geprüft.
    Falls die Listen nicht gleich sind, wird false zurückgegeben, sonst true.
    ...
    Diese wird inkrementiert, falls der Zweig, der an ein Element angefügt
    wurde,
    höhenbestimmend ist.
