...
\begin{document}
    ...
    Hier haben wir zwei Optionen: Zum Einen kann bei jedem Funktionsdurchlauf
    der derzeitige Knoten selbst betrachtet werden (rechts).
    ...
    Dies kann zu einer Komplexität von bis zu
    \begin{math}
        O(n)
    \end{math},
    führen.
