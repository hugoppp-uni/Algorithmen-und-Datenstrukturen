...
Zur Analyse der finalen Implementation, siehe
Absatz~\textit{\hyperref[par:pivots]{Vergleich der Pivot Methoden}}.
...
\subsubsection{Vergleich der Pivot Methoden}\label{subsubsec:pivots}
