...
sich in Abbildung~\ref{fig:hsort} mit bloßem Auge eine Krümmung der Kurve
erkennen.
...
Außerdem in Abbildung~\ref{fig:hsort} zu sehen ist der Best-Case.
...
In Abbildung~\ref{fig:hsort} lässt sich aufsteigend klar eine bessere
...
Die schlechtesten Rahmenbedingungen (Left-Pivot und aufsteigende Zahlen) und
eine durchschnittliches Laufzeitverhalten (Left-Pivot und zufällig generierte
Liste) wurden für den Vergleich von Quicksort mit Heapsort gewählt.
