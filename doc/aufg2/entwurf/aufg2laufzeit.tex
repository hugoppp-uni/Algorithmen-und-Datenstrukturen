...
Unerwartete Ergebnisse erhalten wir jedoch beim Sortieren einer bereits sortierten bzw. aufsteigend-sortierten Liste.
...
Wir haben die Parameter für Quicksort und einen Vergleich von Quicksort und Heapsort wiefolgt gewählt:

Einerseits die schlechtesten Rahmenbedingungen für Quicksort (Left-Pivot und aufsteigende Zahlen).
Andererseits Rahmenbedingungen für eine durchschnittliche Laufzeit von Quicksort (Left-Pivot und zufaellig generierte Liste).
Für Heapsort verwenden wir wieder die Laufzeiten aus Abbildung~\ref{fig:hsort}.
